...
def main(argv):
    ...
    parser.add_argument("--maxISIforHistPlot", help="max ISI for histogram plot (sec)", type=float, default=0.2)
    ...
    ISIsHistBinsc = np.arange(0, maxISIinHist, ISIsHistBinSize) # bins in ms to avoid rounding problem
